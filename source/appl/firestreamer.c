...
bool_t FireStreamer_initialize (char *url, char *username, char * password, uint32_t width,
    ...
    gchar       *capsstr;
    GstCaps     *caps;
    capsstr = g_strdup_printf("video/x-raw,width=640, height=480, framerate=30/1, format=(string)RGB, interlace-mode=(string)progressive, colorimetry=(string)1:1:5:1");                 //TODO format string
